...
private let windodexMarkdownGitHubSecondaryBackground = DynamicColor(
    light: Color(red: 247 / 255, green: 247 / 255, blue: 249 / 255),
    dark: Color(red: 37 / 255, green: 38 / 255, blue: 42 / 255)
)

private let windodexMarkdownGitHubLink = DynamicColor(
...
struct MarkdownTextView: View {
    ...
    private var inlineStyle: InlineStyle {
        InlineStyle()
            .code(
                .font(AppFont.mono(.body)),
                .fontScale(0.85),
                .backgroundColor(windodexMarkdownGitHubSecondaryBackground)
            )
            .strong(.fontWeight(.semibold))
            .link(.foregroundColor(windodexMarkdownGitHubLink))
    }
    ...
    var body: some View {
        ...
        let baseView = StructuredText(markdown: transformed)
            ...
            .textual.codeBlockStyle(WindodexMarkdownCodeBlockStyle())
...
private struct WindodexMarkdownCodeBlockStyle: StructuredText.CodeBlockStyle {
    func makeBody(configuration: Configuration) -> some View {
        ...
        .background(windodexMarkdownGitHubSecondaryBackground)
