...
private struct SettingsAboutCard: View {
    var body: some View {
        SettingsCard(title: "About") {
            Text("Windodex connects to Codex running locally on your Mac via a relay WebSocket. The relay sees only ciphertext and connection metadata once the secure handshake completes.")
                .font(AppFont.caption())
                .foregroundStyle(.secondary)
        }
    }
