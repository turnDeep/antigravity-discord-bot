...
// Purpose: Defines the wire payloads, device trust records, and crypto helpers for Windodex E2EE.
...
let codexSecureHandshakeTag = "windodex-e2ee-v1"
...
enum CodexSecureTransportError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .invalidQR(let message),
            ...
            return message
        case .decryptFailed:
            return "Unable to decrypt the secure Windodex payload."
        }
    }
}
